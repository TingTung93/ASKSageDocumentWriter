  ...
  return (
    <div className="first-run">
      <div className="first-run-card">
        ...
        <h2>Welcome to {PRODUCT_IDENTITY.name}</h2>
        <p>
          This document co-writer runs entirely in this browser with no application backend. Connect an AI provider,
          bring DOCX templates or reference files, and export the finished draft back to Word.
        </p>
        <ol className="fr-steps">
          <li><span className="n">1</span><span>Connect an approved provider for your document's data classification</span></li>
