...
function pl(index: number, text: string, extra: Partial<import('./sample').ParagraphLine> = {}): import('./sample').ParagraphLine {
  return {
    ...
    alignment: extra.alignment ?? null,
    indent_left_twips: extra.indent_left_twips ?? null,
    indent_first_line_twips: extra.indent_first_line_twips ?? null,
    indent_hanging_twips: extra.indent_hanging_twips ?? null,
